...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Barcode.ReaderResultJobResponse();
  });
  ...
  describe('ReaderResultJobResponse', function() {
    it('should create an instance of ReaderResultJobResponse', function() {
      // uncomment below and update the code to test ReaderResultJobResponse
      //var instane = new Barcode.ReaderResultJobResponse();
      //expect(instance).to.be.a(Barcode.ReaderResultJobResponse);
    });
