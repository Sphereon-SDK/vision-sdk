...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Barcode.ReaderJob();
  });
  ...
  describe('ReaderJob', function() {
    it('should create an instance of ReaderJob', function() {
      // uncomment below and update the code to test ReaderJob
      //var instane = new Barcode.ReaderJob();
      //expect(instance).to.be.a(Barcode.ReaderJob);
    });
