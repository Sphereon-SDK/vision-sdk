...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Barcode.BarcodeCoordinate();
  });
  ...
  describe('BarcodeCoordinate', function() {
    it('should create an instance of BarcodeCoordinate', function() {
      // uncomment below and update the code to test BarcodeCoordinate
      //var instane = new Barcode.BarcodeCoordinate();
      //expect(instance).to.be.a(Barcode.BarcodeCoordinate);
    });
