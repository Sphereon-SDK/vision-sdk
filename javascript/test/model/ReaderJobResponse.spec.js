...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Barcode.ReaderJobResponse();
  });
  ...
  describe('ReaderJobResponse', function() {
    it('should create an instance of ReaderJobResponse', function() {
      // uncomment below and update the code to test ReaderJobResponse
      //var instane = new Barcode.ReaderJobResponse();
      //expect(instance).to.be.a(Barcode.ReaderJobResponse);
    });
