...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Barcode.ReaderEngineTask();
  });
  ...
  describe('ReaderEngineTask', function() {
    it('should create an instance of ReaderEngineTask', function() {
      // uncomment below and update the code to test ReaderEngineTask
      //var instane = new Barcode.ReaderEngineTask();
      //expect(instance).to.be.a(Barcode.ReaderEngineTask);
    });
