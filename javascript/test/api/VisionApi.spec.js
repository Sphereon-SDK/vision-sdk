...
(function(root, factory) {
  ...
  describe('VisionApi', function() {
    ...
    describe('submitVisionJob', function() {
      it('should call submitVisionJob successfully', function(done) {
        //uncomment below and update the code to test submitVisionJob
        //instance.submitVisionJob(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
