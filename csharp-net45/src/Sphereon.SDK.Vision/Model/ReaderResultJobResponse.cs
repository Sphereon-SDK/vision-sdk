...
namespace Sphereon.SDK.Vision.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReaderResultJobResponse :  IEquatable<ReaderResultJobResponse>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReaderResultJobResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ReaderResultJobResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReaderResultJobResponse" /> class.
        /// </summary>
        /// <param name="JobId">JobId.</param>
        /// <param name="Inputs">The original input files. Currently supported inputs are: tif files (required).</param>
        /// <param name="Barcodes">The returned barcodes (required).</param>
        /// <param name="Job">Job.</param>
        /// <param name="Tasks">The server supplied reader task(s).</param>
        public ReaderResultJobResponse(string JobId = null, List<string> Inputs = null, List<Barcode> Barcodes = null, ReaderJob Job = null, List<ReaderEngineTask> Tasks = null)
        {
            // to ensure "Inputs" is required (not null)
            if (Inputs == null)
            {
                throw new InvalidDataException("Inputs is a required property for ReaderResultJobResponse and cannot be null");
            }
            else
            {
                this.Inputs = Inputs;
            ...
            if (Barcodes == null)
            {
                throw new InvalidDataException("Barcodes is a required property for ReaderResultJobResponse and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ReaderResultJobResponse);
        }

        /// <summary>
        /// Returns true if ReaderResultJobResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ReaderResultJobResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReaderResultJobResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
